...
Gem::Specification.new do |s|
  s.name = %q{catalogchoice-ar_mailer}
  s.version = "2.1.6"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Eric Hodel", "Adam Meehan", "CatalogChoice"]
  s.date = %q{2009-07-06}
  ...
  s.email = %q{cc-dev@catalogchoice.org}
  ...
  s.homepage = %q{http://github.com/catalogchoice/ar_mailer}
